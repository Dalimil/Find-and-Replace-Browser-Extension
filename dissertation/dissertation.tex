...
The extension has received excellent reviews, has been mentioned in a Medium article, and at the time of writing is installed on over 6000 active devices (users from both browsers combined).
}
...
\chapter{Conclusions}
The extension has received excellent reviews and at the time of writing is installed on over 6000 active devices (users from both browsers combined), $4.7/5$ stars (21 reviews) on the Chrome Web Store and $4.8/5$ stars (7 reviews) on the Firefox Web Store.

In February it was featured in a Medium article\footnote{\url{https://medium.com/@joisig/startupresources-io-issue-97-36a52e6e8478}} as well as on the \textit{StartupResources.io} page as the \textit{Tool of the week}.\footnote{\url{http://issues.startupresources.io/archive/93526}}
