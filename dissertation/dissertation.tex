...
The extension has received excellent reviews and at the time of writing is installed on over 6000 active devices (users from both browsers combined), $4.7/5$ stars (23 reviews) on the Chrome Web Store and $4.8/5$ stars (8 reviews) on the Firefox Web Store. A small sample of these reviews can be found in the appendix (\autoref{section:feedback-reviews}).
