...
The extension has received excellent reviews, has been mentioned in a Medium article, and at the time of writing has over 4000 weekly users (users from both browsers combined).
}
...
About eight releases were a direct response to written user feedback that I received, submitted either via feedback forms or (in about four cases) via a direct email message. Further, about five releases were linked to discussions with the project supervisor, about two were a reaction to data received through Google Analytics, one was addressing the results of our user study, and the rest of the releases were results of own ideation or simply work that had to be done on the extension.
