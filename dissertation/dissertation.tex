...
one.\footnote{\href{https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/text}{https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/text}}
...
Multi-line plain-text input space.\footnote{\href{https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea}{https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea}} This should be a common target for find \& replace. It is used by many sites to allow users compose longer pieces of text, one of them is a new post creation process on Reddit.
...
therefore not limited to \texttt{div} tags.\footnote{\href{https://developer.mozilla.org/en-US/docs/Web/HTML/Global\_attributes/contenteditable}{https://developer.mozilla.org/en-US/docs/Web/HTML/Global\_attributes/contenteditable}}
